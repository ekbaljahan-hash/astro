...
const discoverData = [
  // PHENOMENA
  { tag:'phenomenon', title:'Magnetar Starquake', desc:'A magnetar can release more energy in 0.1 seconds than our Sun emits in 100,000 years — caused by fractures in its ultra-dense crystalline crust.', img:'https://cdn.esahubble.org/archives/images/screen/heic2504a.jpg', wiki:'https://en.wikipedia.org/wiki/Magnetar' },
  { tag:'phenomenon', title:'Quantum Chromodynamic Plasma', desc:'A quark-gluon plasma existed microseconds after the Big Bang — a soup of free quarks behaving like a perfect liquid with near-zero viscosity.', img:'https://news.mit.edu/sites/default/files/images/201006/20100608165022-1.jpg', wiki:'https://en.wikipedia.org/wiki/Quark%E2%80%93gluon_plasma' },
  { tag:'phenomenon', title:'Cosmic Ray Air Shower', desc:'A single ultra-high-energy cosmic ray particle hits Earth\'s atmosphere and spawns billions of secondary particles in a cascading shower detectable across kilometers.', img:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQjwx2sQ5pCDBpdY5ZOb85Er31Upq8L4R_GiQ&s', wiki:'https://en.wikipedia.org/wiki/Air_shower_(physics)' },
  { tag:'phenomenon', title:'Hawking Radiation', desc:'Black holes slowly evaporate by emitting thermal radiation due to quantum effects near the event horizon — meaning even black holes eventually die.', img:'https://www.astronomy.com/wp-content/uploads/2025/04/Hawking-Radiation.png', wiki:'https://en.wikipedia.org/wiki/Hawking_radiation' },
  { tag:'phenomenon', title:'Gravitational Lensing Arcs', desc:'Massive galaxy clusters bend spacetime so severely that background galaxies are smeared into luminous arcs and rings — acting as natural cosmic telescopes.', img:'https://upload.wikimedia.org/wikipedia/commons/thumb/5/5b/A_Horseshoe_Einstein_Ring_from_Hubble.JPG/640px-A_Horseshoe_Einstein_Ring_from_Hubblhttps://www.astronomy.com/wp-content/uploads/2025/04/Hawking-Radiation.pnge.JPG', wiki:'https://en.wikipedia.org/wiki/Gravitational_lens' },
